package fontys.sem6.circline.postservice.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.sem6.circline.postservice.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.sem6.circline.postservice.security.isauthenticated.IsAuthenticated)")
